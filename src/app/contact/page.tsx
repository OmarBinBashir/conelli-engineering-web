            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-100 p-6 rounded-lg">
                  <h3 className="text-xl font-bold mb-3">Lagos (Headquarters)</h3>
                  <div className="space-y-3">
                    <p className="flex items-start">
                      ...
                      <span>15 Victoria Island Way<br />Lagos, Nigeria</span>
                    </p>
                    <p className="flex items-start">
                      <svg className="h-6 w-6 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <p className="flex items-start">
                      ...
                      <span>lagos@conelliengineering.com</span>
                    </p>
                  </div>
                </div>
                ...
                {/* Abuja Office */}
                <div className="bg-gray-100 p-6 rounded-lg">
                  <h3 className="text-xl font-bold mb-3">Abuja</h3>
                  <div className="space-y-3">
                    <p className="flex items-start">
                      <svg className="h-6 w-6 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      ...
                      <span>7 Constitution Avenue<br />Central Business District<br />Abuja, Nigeria</span>
                    </p>
                    <p className="flex items-start">
                      <svg className="h-6 w-6 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      <span>+234 (0) 9 876 5432</span>
                    </p>
                    <p className="flex items-start">
                      <svg className="h-6 w-6 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      <span>abuja@conelliengineering.com</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 p-6 rounded-lg">
                  <h3 className="text-xl font-bold mb-3">Port Harcourt</h3>
                  <div className="space-y-3">
                    <p className="flex items-start">
                      <svg className="h-6 w-6 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      ...
                      <span>24 Aba Road<br />Port Harcourt<br />Rivers State, Nigeria</span>
                    </p>
                    <p className="flex items-start">
                      <svg className="h-6 w-6 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      <span>+234 (0) 8 345 6789</span>
                    </p>
                    <p className="flex items-start">
                      <svg className="h-6 w-6 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      <span>portharcourt@conelliengineering.com</span>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative h-[500px] rounded-lg overflow-hidden shadow-lg">
            <div className="absolute inset-0 bg-gray-300 flex items-center justify-center">
              <p className="text-lg font-medium">Google Maps Embed Would Go Here</p>
            </div>
          </div>
          
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              Visit one of our offices across Nigeria or send us a message to discuss your project.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {[
              ...
              {
                question: 'Does Conelli Engineering work on projects outside of Nigeria?',
                answer: 'While our primary focus is on projects within Nigeria, we do consider select projects in other West African countries. Please contact us with your specific requirements to discuss possibilities.'
              },
              {
              ...
              },
              {
                ...
                answer: 'Sustainability is central to our approach. We incorporate energy-efficient designs, sustainable materials, water conservation measures, and renewable energy solutions where appropriate. Our sustainability team can work with you to achieve green building certifications like LEED or EDGE.'
              },
            ].map((faq, index) => (
